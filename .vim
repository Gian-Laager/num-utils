...
nnoremap <leader><leader>b :T cmake --build cmake-build-debug --target num-utils-test<CR>
nnoremap <leader><leader>B :T cmake --build cmake-build-release --target num-utils-test<CR>
...
nnoremap <leader><leader>t :T cmake --build cmake-build-debug --target num-utils-test && ./cmake-build-debug/test/num-utils-test<CR>
nnoremap <leader><leader>T :T cmake --build cmake-build-release --target num-utils-test && ./cmake-build-release/test/num-utils-test<CR>
